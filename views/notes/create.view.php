    ...
    <div class="space-y-12">
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="sm:col-span-4">
            ...
            <input type="text" name="title" id="title" class="w-full border rounded border-white flex-1 bg-transparent py-1.5 pl-1 focus:ring-0 text-lg leading-6" value="<?= $_POST['title'] ?? '' ?>">
          ...
          <div class="col-span-full">
            ...
            <textarea id="body" name="body" rows="3" class="w-full border rounded border-white flex-1 bg-transparent py-1.5 pl-1 focus:ring-0 text-lg leading-6" value="<?= $_POST['body'] ?? '' ?>"></textarea>
            <p class="mt-3 text-sm leading-6 text-gray-200">Write a few sentences about your thought.</p>
          </div>
  
          <div class="mt-6 flex gap-x-6">
            <button type="reset" class="text-lg font-semibold leading-6">Cancel</button>
